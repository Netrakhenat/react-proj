...
import "./Sidebar.css";
import CreateNotes from "../Create Notes/LapCreateNotes";
import LapNotesTitle from "../Notes Title/LapNotesTitle";
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar_note_titles">
        {titles.length > 0 ? (
          titles.map((title, index) => <LapNotesTitle key={index} title={title} />)
        ) : (
          <div>
          </div>
        )}
